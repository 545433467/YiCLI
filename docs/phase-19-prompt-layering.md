...
```text
src/main/java/com/yicli/prompt/
...
2. 用户级覆盖：`~/.yicli/prompts/...`
3. 项目级覆盖：`.yicli/prompts/...`

例如：

```text
~/.yicli/prompts/base.md
~/.yicli/prompts/modes/agent.md
.yicli/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.yicli/prompts/...`
- [x] 支持项目级覆盖 `.yicli/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
