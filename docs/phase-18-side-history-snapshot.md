...
新增包：`src/main/java/com/yicli/snapshot/`
...
```text
~/.yicli/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dyicli.snapshot.enabled=false
-Dyicli.snapshot.max=50
-Dyicli.snapshot.excludes=...
```
