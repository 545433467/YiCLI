package com.yicli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[yicli] stdout reader stopped: " + e.getMessage());
            }
        }, "yicli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[yicli] stderr reader stopped: " + e.getMessage());
            }
        }, "yicli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
