...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("yicli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("YICLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".yicli", "runtime").toString();
        }
