...
import com.yicli.mcp.mention.AtMentionCompleter;
...
final class YiCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    YiCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
