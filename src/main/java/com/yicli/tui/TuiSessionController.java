...
import com.yicli.tui.history.ConversationSnapshot;
import com.yicli.tui.pane.CenterPane;
import com.yicli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final YiCliConfig config;
    ...
    public TuiSessionController(YiCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "yicli-tui-agent-runner");
