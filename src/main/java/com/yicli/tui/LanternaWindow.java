...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(YiCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("YiCLI v16.0.0");
