...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.yicli.skill.SkillRegistry skillRegistry,
                               com.yicli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "yicli-multi-agent");
            t.setDaemon(true);
            return t;
        });
